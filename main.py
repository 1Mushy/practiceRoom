...
five_minute_alerts = ['./Gascho5.mp3', './Albert5.mp3', './Kim5.mp3', './Rowe5.mp3', './West5.mp3', './Rogers5a.mp3', './Rogers5b.mp3']
ten_minute_alerts = ['./Gascho10.mp3', './Albert10.mp3', './Kim10.mp3', './Rowe10.mp3', './West10.mp3', './Rogers10a.mp3', './Rogers10b.mp3']
...
def mainScript():
    ...
    while repeatVar > 0:
        ...
        mixer.init()
        mixer.stop()
        mixer.music.load(ten_minute_alerts[random.randint(0, len(ten_minute_alerts) - 1)])
        mixer.music.play()
        print(datetime.now())
        ...
        mixer.init()
        mixer.stop
        mixer.music.load(five_minute_alerts[random.randint(0, len(five_minute_alerts) - 1)])
        mixer.music.play()
        print(datetime.now())
